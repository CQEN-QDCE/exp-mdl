...
La veille sur les permis de conduire numériques vise répondre à quatre objectifs principaux : (1) identifier les avantages et les inconvénients liés à  la mise en œuvre des permis de conduire numériques, (2) fournir un aperçu de l'état actuel de l'adoption des permis de conduire numériques à l'échelle mondiale, (3) comprendre les implications technologiques, juridiques et sociales liées à l'adoption des permis de conduire numériques et (4) comprendre les normes et bibliothèques utilisées pour les permis de conduire numériques.

Le permis de conduire numériques représente une avancée majeure dans la transformation numérique des documents qui atteste sur le droit de conduire. Ce permis, porté sur des appareils mobiles intelligents, permettent aux utilisateurs de prouver leur identité et leur droit de conduire sans dépendre de documents physiques. Les permis de conduire numériques se distinguent par:
...
Toutefois, leur adoption à grande échelle fait face à des défis tels que :
...
Le **Canada** adopte une approche structurée et cohérente pour le développement des permis de conduire numériques, combinant avancées technologiques, harmonisation juridique et coordination entre les différents paliers de gouvernement. Le cadre de gouvernance CANdy, élaboré en partenariat avec IBM Consulting et les gouvernements provinciaux, vise à instaurer une confiance numérique et une interopérabilité accrues. Des initiatives comme les nouveaux services en ligne de la SAAQ au Québec et le programme d’identité numérique de l’Ontario illustrent cette dynamique, bien que les permis numériques ne soient pas encore pleinement opérationnels.

Dans ce contexte, le **Québec** occupe une position de premier plan. Grâce à sa nouvelle Loi 82 sur l’identité numérique, la province bénéficie d’un cadre juridique clair et robuste permettant de développer des solutions sécuritaires, interopérables et centrées sur l’utilisateur. Cette base législative, alliée à une gouvernance de l’identité numérique déjà en place, place le Québec parmi les pionniers canadiens, au même titre que la Colombie-Britannique. Elle offre la possibilité d’adopter un modèle hybride combinant les attestations ANONCREDS pour les besoins internes et la norme internationale ISO-18013-5 mDL pour répondre aux enjeux internationaux, confortant ainsi la vision d’un écosystème numérique de confiance.

Sur le plan national, les échanges lors du Colloque des ministres et sous-ministres fédéraux, provinciaux et territoriaux sur la confiance numérique et la cybersécurité ont souligné l’importance d’un environnement numérique à la fois sécuritaire, interopérable et diversifié, permettant aux citoyens de choisir librement leurs modalités d’identification. Le modèle hybride soutenu par le Québec répond précisément à cette attente, en alliant flexibilité, conformité, sécurité et respect des besoins variés des usagers.

En optant pour cette approche hybride, le **Québec** consolide son leadership en matière d’identité numérique. Il anticipe les évolutions réglementaires internationales, s’adapte aux différentes technologies et poursuit une dynamique d’amélioration continue de ses services publics numériques. Ce positionnement stratégique, fondé sur la confiance, la sécurité et l’innovation, permet au Québec de s’inscrire durablement dans un écosystème numérique en expansion, offrant aux citoyens une expérience optimale et conforme aux exigences législatives, tout en étant prêt à s’intégrer harmonieusement dans le paysage mondial de l’identité numérique.

En Amérique du Sud, le **Brésil** se distingue comme pionnier avec l’adoption de permis de conduire numériques disponibles depuis 2019 pour 60 millions de conducteurs, permettant un usage pratique au format mobile ou PDF pour des contrôles et des transactions comme la location de voitures. Le **Paraguay**, quant à lui, a récemment légalisé les permis numériques avec la loi n° 7177/2023, mais leur mise en œuvre est limitée par l’absence de cadre de protection des données et des réglementations adaptées, nécessitant des réformes pour assurer leur fiabilité et le respect des droits des citoyens.
...
Les expériences internationales, notamment en Australie et aux États-Unis, montrent un fort potentiel d'adoption des permis de conduire numériques, comme en témoignent les millions de téléchargements enregistrés. Ce succès laisse présager une adoption favorable de cette technologie dans une société comme le Canada. Cependant, pour garantir une transition inclusive, plusieurs aspects doivent être pris en compte: 
- **Inclusion numérique**: Pour éviter les exclusions des populations marginalisées, comme les autochtones et les personnes âgées, il est important de maintenir des permis physiques parallèlement aux solutions numériques. Cela garantira un accès équitable à tous les citoyens, indépendamment de leurs compétences numériques ou de leur localisation géographique. De plus, des services d'accompagnement devraient être mis en place pour aider les citoyens et les parties prenantes (corps policiers, commerces, etc.) dans l'adoption et l'utilisation de la technologie.
...
- Phase d'exploration et d'analyse de l'écosystème du permis de conduire mobile.
- Phase d'implémentation du cycle de vie complet d'un permis de conduire numérique dans le contexte des attestations vérifiables :
  ...
  - Infrastructure de Clés Publiques (ICP) : Mettre en place une ICP pour l'intégrer à l'écosystème du permis de conduire numérique.
...
- ✅ Compréhension et apprentissage de la norme ISO 18013-5
- ✅ Compréhension des contraintes imposées par le Guide d'Implémentation de l'AAMVA et son impact sur l'architecture du projet.
...
- ✅ Un agent ACA-Py avec les plugins OID4VCI ("OpenID for Verifiable Credential Issuance") et mso-mdoc ("Mobile Security Object") a été déployé pour l'émission d'un permis de conduire mobile au format mDL.
  - Le plugin OID4VCI pour l'émission d'une attestation vérifiable.
  - Le plugin mso-doc pour l'authentification (signature) de l'émission.
- ✅ Un prototype d'application web frontend (contrôleur) a été associé à l'agent ACA-Py pour la saisie des informations du permis de conduire numérique.
...
- ✅ Une application portefeuille numérique a été mise en place avec la librairie [mdl-ts](https://github.com/CQEN-QDCE/mdl-ts) pour supporter le format mdoc conforme à la norme ISO/IEC 18013-5 (mDL)
- ✅ L'application de portefeuille numérique a été publiée en phase de test interne dans Google Play Console pour être capable de l'installer sur un appareil Android.
...
- Accessibilité : une inclusion numérique est nécessaire pour ne pas marginaliser certaines populations, comme les communautés éloignées ou les personnes âgées
