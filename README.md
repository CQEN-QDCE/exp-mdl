...
- Code des prototypes:
  ...
  - [portefeuille-mobile-mdl](./portefeuille-mobile-mdl/README.md): Application mobile (react native) de portefeuille électronique qui permet de recevoir le permis de conduire mobile (mDL).
